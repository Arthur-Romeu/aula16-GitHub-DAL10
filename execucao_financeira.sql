...
( 
 ...
 cod_ne VARCHAR NOT NULL,  
 cod_emp VARCHAR NOT NULL,  
 valor_empenho NUMERIC (18,2) NOT NULL,  
 valor_pagamento NUMERIC (18,2) NOT NULL  
); 
...
ALTER TABLE data_warehouse.fato_execucao_financeira ADD FOREIGN KEY(id_tempo) REFERENCES data_warehouse.dim_tempo (id)
...
ALTER TABLE data_warehouse.fato_execucao_financeira ADD FOREIGN KEY(id_data_empenho) REFERENCES public.execucao_financeira_despesa (id)
ALTER TABLE data_warehouse.fato_execucao_financeira ADD FOREIGN KEY(id_data_pagamento) REFERENCES public.execucao_financeira_despesa (id)
...
CREATE OR REPLACE VIEW data_warehouse.view_empenho_por_ano
...
FROM (
	...
	FROM data_warehouse.ft_execucao_financeira fef
